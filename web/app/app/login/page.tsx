 ...
 * bounced straight to /app/recordings so hitting the login URL
 * while already logged in isn't a dead end.
 */
...
// Always evaluate on request — the whole point of this page is to
// inspect the current session cookie, which is request-scoped.
